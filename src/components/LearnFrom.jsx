    ...
    return (
        <div className="relative pt-12 pb-8">
            ...
            <div className="md:container max-w-[1322px] mx-auto">
                ...
                <img src="/assets/images/webp/learn-main-image.webp" alt="learn-from-image" className="relative md:block hidden" />
                <img className="relative max-md:block hidden" src="/assets/images/webp/mobile-learn-from.webp" alt="learn-from" />
                <div className="bg-white sm:p-[35px_28px_31px_29px] absolute bottom-[6%] 2xl:left-[17%] left-[6%] max-md:left-[5%] rounded-[25px] max-lg:pt-[30px] max-lg:pb-[26px] max-lg:px-[26px] max-lg:max-w-[339px]">
